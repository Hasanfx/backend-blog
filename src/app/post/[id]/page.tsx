...
import { fetchBlog } from '../../../services/blogPosts';
...
const BlogDetail = () => {
  ...
  const params = useParams(); // This will provide the dynamic params
  ...
  useEffect(() => {
    ...
    const loadBlog = async () => {
      try {
        const data = await fetchBlog(Number(params.id)); // Fetch blog data
        setBlogPost(data);
